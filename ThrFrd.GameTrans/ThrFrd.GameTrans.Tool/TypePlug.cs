...
namespace ThrFrd.GameTrans.Tool
{
    public static class TypePlug
    {
        ...
        public static bool ToBoolean(this object o, bool defaultVal)
        {
            if (o == null) 
            {
                return defaultVal;
            }
            return ToBoolean(o.ToString(), defaultVal);
        }
        public static bool ToBoolean(this string str, bool defaultVal)
        {
        ...
        public static string ToListString(this List<int> o, string split)
        {
            return ToListString(o.Select(c => c.ToString()).ToList(), split);
        }
        public static string ToListString(this List<string> o, string split)
        {
            var sb = new StringBuilder();
            for (int i = 0, len = o.Count; i < len; i++)
            {
                sb.Append(o[i]);
                if (i != len - 1)
                {
        ...
        public static string ToPinyin(this string cn)
        {
            return Hz2Py.Convert(cn);
        }
        public static bool Equal(this string str, string val,bool ignoreCase=false)
        {
            if (str == null) 
            {
                if (val == null)
            ...
            if (ignoreCase) 
            {
                return str.ToLower() == val.ToLower();
            }
            return str == val;
        }
    }
