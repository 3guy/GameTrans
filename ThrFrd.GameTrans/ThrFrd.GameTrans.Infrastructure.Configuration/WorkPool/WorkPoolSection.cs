...
using ThrFrd.GameTrans.Infrastructure.Configuration.WorkPool.Email;

namespace ThrFrd.GameTrans.Infrastructure.Configuration.WorkPool
{
    ...
    public class WorkPoolSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("shortmessagequeue", IsRequired = true)]
        public ShortMessagePool ShortMessageQueue
        {
            get
            {
                return (ShortMessagePool)base["shortmessagequeue"];
            }
        }
    }
}
